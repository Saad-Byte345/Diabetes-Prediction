...
An end-to-end supervised learning study on the Pima Indians Diabetes dataset, benchmarking five classifiers under a shared preprocessing and evaluation pipeline. The goal is to predict the onset of Type-2 diabetes from eight clinical measurements so that at-risk patients can be flagged early.
